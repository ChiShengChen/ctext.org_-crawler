...
"""
男女詩人詞頻分析
基於性別分別統計1-gram、2-gram、4-gram詞頻特徵
"""
...
def analyze_gender_ngrams(ngram_file, df, ngram_type):
    """分析性別 n-gram 特徵"""
...
def generate_gender_markdown_report(gender_stats_1gram, gender_stats_2gram, gender_stats_4gram, df):
    """生成性別詞頻分析 Markdown 報告"""
...
def main():
    ...
    # 分析 1-gram
    print("\n分析 1-gram 數據...")
    gender_stats_1gram = analyze_gender_ngrams(
    ...
    # 分析 2-gram
    print("\n分析 2-gram 數據...")
    gender_stats_2gram = analyze_gender_ngrams(
    ...
    # 分析 4-gram
    print("\n分析 4-gram 數據...")
    gender_stats_4gram = analyze_gender_ngrams(
    ...
    # 生成報告
    print("\n生成 Markdown 報告...")
    markdown_content = generate_gender_markdown_report(
        gender_stats_1gram, 
        gender_stats_2gram, 
        gender_stats_4gram,
        df
    ...
    # 保存報告
    output_file = '/media/meow/One Touch/ctext.org_-crawler/quantangshi_crawler/gender_linguistic_analysis_report.md'
