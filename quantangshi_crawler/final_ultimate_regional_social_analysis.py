...
# -*- coding: utf-8 -*-
"""
最終終極修正版地域與社會階層詩人用字特徵分析
徹底修正所有問題，確保著名詩人被正確識別和排名
"""
...
def analyze_regional_social_ngrams_final_ultimate(ngram_file, df, ngram_type):
    """最終終極版分析地域-社會階層 n-gram 特徵"""
...
def generate_final_ultimate_markdown_report(regional_social_stats_1gram, regional_social_stats_2gram, regional_social_stats_4gram, df):
    """生成最終終極版 Markdown 報告"""
    
    markdown_content = """# 地域與社會階層詩人用字特徵分析（最終終極修正版）
...
def main():
    print("開始最終終極修正版地域與社會階層詩人用字特徵分析...")
    ...
    # 分析 1-gram
    print("\n分析 1-gram 數據...")
    regional_social_stats_1gram = analyze_regional_social_ngrams_final_ultimate(
    ...
    # 分析 2-gram
    print("\n分析 2-gram 數據...")
    regional_social_stats_2gram = analyze_regional_social_ngrams_final_ultimate(
    ...
    # 分析 4-gram
    print("\n分析 4-gram 數據...")
    regional_social_stats_4gram = analyze_regional_social_ngrams_final_ultimate(
    ...
    # 保存報告
    output_file = '/media/meow/One Touch/ctext.org_-crawler/quantangshi_crawler/regional_social_linguistic_analysis_report_final_ultimate.md'
